...
class Program(models.Model):
   ...
   event_end = models.TimeField(max_length=25, default=None, blank=True, null=True)
   duration = models.FloatField(max_length=25, default=None, blank=True, null=True)
   ...
   is_featured = models.CharField(max_length=5, default='No')
   splash_url = models.CharField(max_length=512, default=None, blank=True, null=True)
